    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shoes_Numbers_NumberId",
                        column: x => x.NumberId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tasteShoes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tasteShoes_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tasteShoes_Shoes_ShoeId",
                        column: x => x.ShoeId,
                        principalTable: "Shoes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shoes_NumberId",
                table: "Shoes",
                column: "NumberId");

            migrationBuilder.CreateIndex(
                name: "IX_tasteShoes_AppUserId",
                table: "tasteShoes",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_tasteShoes_ShoeId",
                table: "tasteShoes",
                column: "ShoeId");
        }
